...
class MecanicoController{
    ...
    update(req, res) {
        ...
        notas.atualizar(id, id_mecanico, id_loja, codigo, n_fabricacao, descricao, qtd, unidade, valor, valor_unidade, local_peca).then(
            resposta => {
